...
class TestLearningAuditAlignment(unittest.TestCase):
    ...
    def test_theory_retirement_mutate(self):
        ...
        retired = lineage.retire_stale_theories(step=3, contradiction_severity=0.0, current_record_id=child_rec.id)
    ...
    def test_prediction_temporal_alignment(self):
        ...
        engine.record_day(
            ...
            prior_prediction_result={"actual_direction": "higher", "direction_score": 1.0},
        ...
        engine.record_day(
            ...
            prior_prediction_result={"actual_direction": "higher", "direction_score": 0.0},
