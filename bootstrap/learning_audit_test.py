...
def test_learning_effectiveness_audit():
    ...
    prediction_history = [
        ...
        # Day 1 (Start window)
        {
            ...
            "prior_prediction_result": {
                "direction_score": 1.0
            },  # correct prediction from Day 0 (confidence 0.8), error = 0.2
            "components_failed": [],
        ...
        # Day 2 (Middle window)
        {
            ...
            "prior_prediction_result": {
                "direction_score": 0.0
            },  # incorrect prediction from Day 1 (confidence 0.7), error = 0.7
            "components_failed": [],
            "reused_lessons": [],
            "lessons_retired": 0,
        ...
        # Day 3 (End window)
        {
            ...
            "prior_prediction_result": {
                "direction_score": 0.0
            },  # incorrect prediction from Day 2 (confidence 0.6), error = 0.6
            "components_failed": [],
        ...
        # Day 4 (End window)
        {
            ...
            "prior_prediction_result": {
                "direction_score": 1.0
            },  # correct prediction from Day 3 (confidence 0.5), error = 0.5
            "components_failed": [],
            "reused_lessons": ["lesson_2"],
            "lessons_retired": 0,
    ...
    print(
        "✓ Learning effectiveness audit print journal calculations verified successfully."
    )
