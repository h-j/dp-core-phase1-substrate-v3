...
def test_belief_memory_evolution_and_invariants():
    ...
    mem.store_record(
        ...
        window_2_summary={"active_count": 100, "active_target_count": 80, "control_count": 100, "control_target_count": 20},
        window_3_summary={"active_count": 100, "active_target_count": 78, "control_count": 100, "control_target_count": 22},
        decision_dict=decision_dict,
        ground_truth={"world_id": "WORLD_A", "expected_decision": "ADMIT", "expected_reason": "TRUE_CAUSAL"},
        erc_refs=["REQ_001"],
        ledger_refs=["L_001"]
    )
    ...
    assert active_after_weaken[0]["proposition"]["proposition_id"] == "PROP_TEST_001"  # Identity
    assert active_after_weaken[0]["record_type"] == "WEAKENED_BELIEF"
    assert active_after_weaken[0]["proposition"]["lifecycle_state"] == LifecycleState.WEAKENED_BELIEF
    ...
    assert retired_record["proposition"]["lifecycle_state"] == LifecycleState.RETIRED_BELIEF
    ...
    print("✓ All belief evolution invariants (Identity, Provenance, Temporal, Idempotency, History, Responsiveness) passed successfully.")
