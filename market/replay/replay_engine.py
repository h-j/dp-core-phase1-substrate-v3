    ...
    def execute(self, emit_summary: bool = True):
        ...
        for day_idx in range(len(self.engine)):
            try:
                ...
                # Process observation, trend persistence, horizon calculation & abstraction via step_observation module
...
"""
                ...
                # Evaluate prediction, active principles, WM overrides, and conviction sizing via step_prediction module
                ...
                similar_transitions = pred_res.similar_transitions
                principles_consulted = pred_res.principles_consulted
                principles_accepted = pred_res.principles_accepted
                principles_rejected = pred_res.principles_rejected
                confidence_delta = pred_res.confidence_delta
                world_model_applied = pred_res.world_model_applied
                prediction_override_applied = pred_res.prediction_override_applied
                decisions = pred_res.decisions
                conviction_score = pred_res.conviction_score
                allocation_pct = pred_res.allocation_pct

                # Process prior prediction scoring, causal attribution, proposition compilation, parameter grounding & validation via step_validation module
                ...
                attribution = val_res.prior_attribution
                newly_retired_count = val_res.newly_retired_count
