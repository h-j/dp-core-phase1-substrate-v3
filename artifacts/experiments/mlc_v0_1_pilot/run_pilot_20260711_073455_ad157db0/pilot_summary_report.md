...
### Run Metadata
- **Run ID**: `run_pilot_20260711_073455_ad157db0`
- **Timestamp**: `2026-07-11T02:04:55.822868Z`
- **World Count**: 100
...
| `PILOT_GATE_11_CATASTROPHIC_DECOMPOSITION` | PASS | Found H4 sections: ['pooled', 'false_admit_reject', 'false_admit_evidence_limited', 'false_admit_effect_ambiguous']. |
| `PILOT_GATE_12_POWER_REPORT_COMPLETENESS` | PASS | All required power fields exist for H2, H3, and H4. |
...
- **DEFER Recall**: 0.8776
- **EVIDENCE_LIMITED Subtype Accuracy**: 1.0000
